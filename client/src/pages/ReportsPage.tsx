      ...
      <Card className="rounded-none border-foreground bg-card shadow-panel">
        <CardHeader className="border-b border-border">
          ...
          <p className="max-w-3xl text-sm leading-7 text-muted-foreground">
            每個月份對應一份獨立核算資料。你可以手動新增任意月份、回看歷史紀錄，或直接從列表進入單月公式編輯頁。
          </p>
        </CardHeader>
          ...
          <div className="flex items-end">
            <Button
              ...
              onClick={() => {
                ...
                setLocation(`/reports/${monthInput}`);
              }}
            >
          ...
          <div className="space-y-3">
            {filteredReports.map(report => (
              <button
                ...
                className="flex w-full items-center justify-between border border-border px-4 py-4 text-left transition-colors hover:bg-muted"
              >
                <div>
